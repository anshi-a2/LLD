...
import com.task.managment.system.strategy.DueDateSort;
...
public class Application {
	...
	public static void main(String[] args) {
        ...
        TaskManagmentSystem taskManagementSystem = TaskManagmentSystem.getInstance();
        ...
        // Search tasks
        List<Task> searchResults = taskManagementSystem.searchTasks("Task", new DueDateSort());
